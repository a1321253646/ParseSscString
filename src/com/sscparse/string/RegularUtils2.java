package com.sscparse.string;

import com.sscparse.string.utils.TextUtils;
import com.sscparse.string.utils.XposedBridge;
import org.json.JSONObject;
import org.json.JSONArray;
import java.util.ArrayList;
public class RegularUtils2 {

    public static String regularStr(String str,String orderid){
...
//            }
        ...
        getPai(value);
        dealDate(value);
        JSONArray array = DateBean2.DateBean2ArrayListToJson(value);
        JSONObject jbBack = new JSONObject();
        jbBack.put("orderid",orderid);
        jbBack.put("date", array);
        XposedBridge.log(jbBack.toString());
